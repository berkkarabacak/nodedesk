...
import { MonitorSmartphone, MonitorCog, Layers, Check } from 'lucide-react'
import type { UsageMode } from '../lib/api'
...
const options: { mode: UsageMode; icon: typeof MonitorSmartphone; title: string; text: string; recommended?: boolean }[] = [
  ...
  },
  {
    ...
    text: 'Let your other trusted devices connect to this machine’s desktop, files and terminal.',
  },
  {
    mode: 'both',
    icon: Layers,
    title: 'Both',
    text: 'Control other computers and allow this one to be controlled. Recommended for most people.',
    recommended: true,
  },
]
    ...
    <div className="flex min-h-screen items-center justify-center bg-zinc-950 px-4">
      <div className="w-full max-w-xl">
        ...
        <p className="mt-4 text-center text-xs text-zinc-600">
          NodeDesk will never expose this computer to the public internet.
        </p>
      </div>
    </div>
  )
